...
- Bước 3: Người dùng chọn lớp trong mục `Quản lý lớp`
...
> Ấn `Lưu lại ` hệ thống sẽ giao bài tập thành công
...
- Bước 2: Người dùng click ấn vào `Lịch sử`
...
>  Ấn ` Lưu lại ` thêm học sinh lớp chính thức thành công
